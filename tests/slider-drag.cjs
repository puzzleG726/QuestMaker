...
(async () => {
  ...
  try {
    ...
    await knob.click(); await page.locator('#knobShape [data-option="rectangle"]').click();
    ...
    await page.locator('#downloadButton').click(); await page.locator('#saveExport').click(); await page.locator('#closeExportPreview').click(); const file = await pending;
